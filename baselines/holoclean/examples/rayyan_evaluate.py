...
create_evaluation_format('../../../datasets/rayyan/clean.csv', 
                        '../../../datasets/rayyan/rayyan_clean_eval.csv')
...
hc.load_data('rayyan', '../../../datasets/rayyan/dirty.csv')
hc.load_dcs('../../../datasets/rayyan/rayyan_constraints.txt')
...
print("=== RAYYAN DATASET EVALUATION RESULTS ===")
report = hc.evaluate(fpath='../../../datasets/rayyan/rayyan_clean_eval.csv',
                    tid_col='tid',
                    attr_col='attribute', 
                    val_col='correct_val')
