...
create_evaluation_format('../../../datasets/walmart/clean.csv', 
                        '../../../datasets/walmart/walmart_clean_eval.csv')
...
report = hc.evaluate(fpath='../../../datasets/walmart/walmart_clean_eval.csv',
                    tid_col='tid',
                    attr_col='attribute', 
                    val_col='correct_val')
