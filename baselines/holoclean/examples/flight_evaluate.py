...
create_evaluation_format('../../../datasets/flight/clean.csv', 
                        '../../../datasets/flight/flight_clean_eval.csv')
...
hc.load_data('flight', '../../../datasets/flight/dirty.csv')
hc.load_dcs('../../../datasets/flight/flight_constraints.txt')
...
print("=== FLIGHT DATASET EVALUATION RESULTS ===")
report = hc.evaluate(fpath='../../../datasets/flight/flight_clean_eval.csv',
                    tid_col='tid',
                    attr_col='attribute', 
                    val_col='correct_val')
