...
create_evaluation_format('../../../datasets/movies/clean.csv', 
                        '../../../datasets/movies/movies_clean_eval.csv')
...
hc.load_data('movies', '../../../datasets/movies/dirty.csv')
hc.load_dcs('../../../datasets/movies/movies_constraints.txt')
...
print("=== MOVIES DATASET EVALUATION RESULTS ===")
report = hc.evaluate(fpath='../../../datasets/movies/movies_clean_eval.csv',
                    tid_col='tid',
                    attr_col='attribute', 
                    val_col='correct_val')
