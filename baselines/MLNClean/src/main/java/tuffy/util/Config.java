...
public class Config {
	...
	public static String product_line = "Markov Network";
	public static String product_name = "Markov Network v1.0";
	...
	public static String db_url = "jdbc:postgresql://localhost:5432/mlnclean";
	public static String db_username = "nw";

	public static String db_password = "123456";
	public static String db_schema = "markov_schema";
	 ...
	 * File System
	 */
	public static String dir_working = "/tmp/MarkovNetwork-workspace";
	public static String dir_out = ".";
	public static boolean output_files_in_gzip = false;
	public static String dir_tests = "/tmp/MarkovNetwork-tests";
	public static String file_stats = "MarkovNetwork_stats.txt";
