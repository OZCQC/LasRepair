...
public class Main {
    ...
    public static String baseURL = "/data/nw/DC_ED/References_inner_and_outer/mlnclean/dataset";    // experiment baseURL
...
//            }
    ...
    public static void learnwt(String[] args, ArrayList<Integer> ignoredIDs) throws SQLException, IOException {
        ...
        double startTime = System.currentTimeMillis();    //锟斤拷取锟斤拷始时锟斤拷
...
//        String weightFileURL = baseURL + "/HAI/out.txt";
    ...
    /**
     * 浠巊round truth file涓�鐢熸垚ground_group_file
     */
    ...
    /**
     * 鏍规嵁ground truth 鏂囦欢锛岀敓鎴恎round sample file.
     * */
    ...
    public static HashMap<Integer, String[]> main(String[] args, String[] header, ArrayList<Integer> ignoredIDs, Log log, int threshold) throws SQLException, IOException {
        ...
        //System.out.println("rootURL=" + rootURL);
        cleanedFileURL = baseURL + "/RDBSCleaner_cleaned.txt";  //锟斤拷锟斤拷锟较达拷锟斤拷锟斤拷锟捷硷拷
        System.out.println("dataURL = " + tmp_dataURL);
        ...
        /*
        * 锟斤拷取训锟斤拷锟阶段碉拷clauses权锟截斤拷锟�
        * */
        int batch = 1; // 锟缴碉拷锟斤拷
        List<HashMap<String, Double>> attributesPROBList = new ArrayList<>();
        for (int i = 0; i < batch; i++) {
            //锟斤拷取锟斤拷锟斤拷学习锟矫碉拷锟斤拷锟斤拷权锟截ｏ拷锟斤拷锟斤拷HashMap
...
//        System.exit(0);
        ...
        //锟斤拷每锟斤拷Domain执锟斤拷group by key锟斤拷锟斤拷,锟斤拷锟截诧拷锟斤拷group锟斤拷锟斤拷outlier tuples
        ...
        /**
         * 涓篶rowdsourcing娴嬭瘯锛岀敤鎸囧畾precision
         * 娴嬭瘯group鍚庣殑缁撴灉瀵瑰悗缁�娓呮礂姝ラ�ょ殑褰卞搷
         * */
        double precision = 1;
...
//        domain.printDomainContent(domain.domains);
        ...
        //锟斤拷印锟截革拷锟斤拷锟捷碉拷Tuple ID
        if (null == keysList || keysList.isEmpty()) System.out.println("\tNo duplicate exists.");
        else {
            System.out.println("\n>>> Delete duplicate tuples");
            // 锟斤拷锟斤拷keysList 锟斤拷锟斤拷亩锟斤拷锟絛omain1 锟斤拷每锟斤拷group 锟斤拷锟斤拷锟絢ey值锟斤拷锟斤拷些锟斤拷锟叫匡拷锟杰伙拷锟截革拷锟侥ｏ拷锟斤拷去锟斤拷
            // domain.printDataSet(domain.dataSet);
//             domain.deleteDuplicate(keysList, domain.dataSet);	//执锟斤拷去锟截诧拷锟斤拷
            // domain.printDataSet(domain.dataSet);
            System.out.println(">>> completed!");
        }
    ...
    public static void writeToFile(String[] header, ArrayList<String> list, String outFile) {
        ...
        try {
            if (file.exists()) {
                System.out.println("锟侥硷拷锟窖达拷锟斤拷: " + outFile);
    ...
    public static void writeToFile(String cleanedFileURL, HashMap<Integer, String[]> dataSet, String[] header) {
        ...
        try {
            ...
            } else if (!file.getParentFile().exists()) {// 锟叫讹拷目锟斤拷锟侥硷拷锟斤拷锟节碉拷目录锟角凤拷锟斤拷锟�
                // 锟斤拷锟侥匡拷锟斤拷募锟斤拷锟斤拷诘锟斤拷募锟斤拷胁锟斤拷锟斤拷冢锟斤拷虼唇锟斤拷锟斤拷募锟斤拷锟�
