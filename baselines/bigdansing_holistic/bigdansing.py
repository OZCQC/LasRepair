    ...
    def run(self, file_path, dirty_path, clean_path):
        ...
        if True:
            ...
            if not PERFECTED:
                ...
                print("proportion of clean value in candidates:"+str(len(self.clean_in_cands)/(rep_total+1e-10)))
                print("proportion of clean value in candidates and selected correctly:"+str(len(self.clean_in_cands_repair_right)/(len(self.clean_in_cands)+1e-10)))
                f.close()
